...
<ParamField body="country" type="enum">
  Country where the transaction must be processed (MAX 2; MIN 2; <a href="/reference/reference/country-reference">ISO 3166-1</a> ).

  Possible enum values: Check the <a href="/reference/reference/country-reference">Country reference</a>.
</ParamField>
...
<ParamField body="amount" type="object">
  ...
  <Expandable title="properties">
    ...
    <ParamField body="currency" type="enum">
      The currency used to make the payment (MAX 3; MIN 3; <a href="/reference/reference/country-reference">ISO 4217</a> ).
...
<ParamField body="customer_payer" type="object">
  ...
  <Expandable title="properties">
    ...
    <ParamField body="nationality" type="enum">
      The customer's nationality (MAX 2; MIN 2; <a href="/reference/reference/country-reference">ISO 3166-1</a> ).
          ...
          <Expandable title="properties">
            ...
            <ParamField body="document" type="object">
              ...
              <Expandable title="properties">
                ...
                <ParamField body="country" type="enum">
                  Country where the document was issued (MAX 2; MIN 2; <a href="country-reference">ISO
                                          3166-1</a> ).
            ...
            <ParamField body="loyalty_tier" type="enum">
              ...
              Possible enum values: Check the <a href="/reference/reference/airline-information">
                                    Loyalty tier</a>.
            </ParamField>
            ...
            <ParamField body="type" type="enum">
              ...
              Possible enum values: Check the <a href="/reference/reference/airline-information">Passenger type list</a>.
            </ParamField>
        ...
        <ParamField body="items" type="array of object">
          ...
          <Expandable title="properties">
            ...
            <ParamField body="category" type="string">
              ...
              Possible values: Check the <a href="/reference/reference/items-category-list">Item category list</a>.
            </ParamField>
    ...
    <ParamField body="seller_details" type="object">
      ...
      <Expandable title="properties">
        ...
        <ParamField body="industry" type="enum">
          ...
          Possible enum values: Check the <a href="/reference/reference/industry-category-list">Industry category</a>.
        </ParamField>
