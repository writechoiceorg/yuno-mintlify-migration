...
This page presents examples of requests and responses for creating Bank Transfer payments using the [Create Payment](https://docs.y.uno/reference/create-payment) endpoint.
