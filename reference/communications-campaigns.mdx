...
* [Create campaign](https://docs.y.uno/reference/create-campaign)
* [Get campaign](https://docs.y.uno/reference/get-campaign)
* [List campaigns](https://docs.y.uno/reference/list-campaigns)
* [Update campaign status](https://docs.y.uno/reference/update-campaign-status)
* [Create rules](https://docs.y.uno/reference/create-rules)
* [Get rule](https://docs.y.uno/reference/get-rule)
* [Update rule](https://docs.y.uno/reference/update-rule)
* [Update rule status](https://docs.y.uno/reference/update-rule-status)
