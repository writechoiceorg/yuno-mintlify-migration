...
To test all possible transaction outcomes within Yuno in **Sandbox**, please refer to the following [documentation](/docs/using-yuno/testing/yuno-testing-gateway#4-provide-the-payment-method-information) for **test data**.
