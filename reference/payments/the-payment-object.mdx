...
<Note>
  **Metadata and routing logic**
  ...
  For routing logic to work correctly, metadata must **also** be set at the [Checkout Session](https://docs.y.uno/reference/the-checkout-session-object) level. Setting it only on the Payment object will not trigger route logic.
</Note>
...
<ParamField body="country" type="enum">
  Country where the transaction must be processed (MAX 2; MIN 2; <a href="country-reference">ISO 3166-1</a> ).

  Possible enum values: Check the <a href="country-reference">Country reference</a>.
</ParamField>
...
<ParamField body="amount" type="object">
  ...
  <Expandable title="properties">
    ...
    <ParamField body="currency" type="enum">
      The currency used to make the payment (MAX 3; MIN 3; <a href="country-reference">ISO 4217</a> ).
...
<ParamField body="payment_method" type="object">
  ...
  <Expandable title="properties">
    ...
    <ParamField body="type" type="enum">
      ...
      Possible enum values: check the <a href="payment-type-list">payment type reference</a>.
    </ParamField>
            ...
            <ParamField body="three_d_secure" type="object">
              ...
              <Expandable title="properties">
                ...
                <ParamField body="electronic_commerce_indicator" type="string">
                  This field must be completed with the result of the <a href="eci-indicators-list">ECI</a> field provided by the 3d Secure
        ...
        <ParamField body="bank_transfer" type="object">
          ...
          <Expandable title="properties">
            ...
            <ParamField body="beneficiary_document_type" type="string">
              ...
              Possible values: Check the <a href="country-reference">
            ...
            <ParamField body="customer_data" type="object">
              ...
              <Expandable title="properties">
                ...
                <ParamField body="identification_type" type="string">
                  ...
                  Check the <a href="country-reference">
                                            Country reference</a>. Example: DNI
                </ParamField>
...
<ParamField body="customer_payer" type="object">
  ...
  <Expandable title="properties">
    ...
    <ParamField body="nationality" type="enum">
      The customer's nationality (MAX 2; MIN 2; <a href="country-reference">ISO 3166-1</a> ).
    ...
    <ParamField body="document" type="object">
      ...
      <Expandable title="properties">
        ...
        <ParamField body="document_type" type="enum">
          ...
          Possible enum values: Check the <a href="country-reference">
                            Country reference</a>.
        </ParamField>
    ...
    <ParamField body="billing_address" type="object">
      ...
      <Expandable title="properties">
        ...
        <ParamField body="country" type="enum">
          The country considered for the billing address (MAX 2; MIN 2; <a href="country-reference">ISO
                          3166-1</a> ).
    ...
    <ParamField body="shipping_address" type="object">
      ...
      <Expandable title="properties">
        ...
        <ParamField body="country" type="enum">
          The country considered for the shipping address (MAX 2; MIN 2; <a href="country-reference">ISO
                          3166-1</a> ).
      ...
      <Expandable title="properties">
        ...
        <ParamField body="legs" type="array of objects">
          ...
          <Expandable title="properties">
            ...
            <ParamField body="base_fare_currency" type="string">
              The currency used to transaction amount (MAX 3; MIN 3; <a href="country-reference">ISO 4217</a> ).

              Example: Check the <a href="country-reference">Country reference</a>.
            </ParamField>
        ...
        <ParamField body="passengers" type="array of objects">
          ...
          <Expandable title="properties">
            ...
            <ParamField body="country" type="enum">
              Country where the document was issued (MAX 2; MIN 2; <a href="country-reference">ISO 3166-1</a> ).
            ...
            <ParamField body="loyalty_tier" type="enum">
              ...
              Possible enum values: Check the <a href="airline-information">
                                    Loyalty tier</a>.
            </ParamField>
            ...
            <ParamField body="nationality" type="enum">
              The passenger's nationality (MAX 2; MIN 2; <a href="country-reference">ISO 3166-1</a> ).
            ...
            <ParamField body="type" type="enum">
              ...
              Possible enum values: Check the <a href="airline-information">Passenger type list</a>.
            </ParamField>
          ...
          <Expandable title="properties">
            ...
            <ParamField body="issue" type="object">
              ...
              <Expandable title="properties">
                ...
                <ParamField body="country" type="enum">
                  Country code where the ticket was issued (MAX 2; MIN 2; <a href="country-reference">ISO
                                          3166-1</a> ).

                  Possible enum values: Check the <a href="country-reference">Country code
                                            list</a>.
                </ParamField>
        ...
        <ParamField body="items" type="array of object">
          ...
          <Expandable title="properties">
            ...
            <ParamField body="category" type="string">
              ...
              Possible values: Check the <a href="items-category-list">Item category list</a>.
            </ParamField>
              ...
              <Expandable title="properties">
                ...
                <ParamField body="address" type="object">
                  ...
                  <Expandable title="properties">
                    ...
                    <ParamField body="country" type="enum">
                      The country considered for the event's address (MAX 2; MIN 2, <a href="country-reference">ISO
                                                  3166-1</a> ).
        ...
        <ParamField body="shipping" type="object">
          ...
          <Expandable title="properties">
            ...
            <ParamField body="type" type="enum">
              ...
              Possible enum values: Check the <a href="shipping-reference">Shipping reference</a>.
            </ParamField>
          ...
          <Expandable title="properties">
            ...
            <ParamField body="sender" type="object">
              ...
              <Expandable title="properties">
                ...
                <ParamField body="country" type="enum">
                  Sender's country (MAX 2; MIN 2; <a href="country-reference">ISO 3166-1</a> ).
            ...
            <ParamField body="recipient" type="object">
              ...
              <Expandable title="properties">
                ...
                <ParamField body="country" type="enum">
                  Recipient's country (MAX 2; MIN 2; <a href="country-reference">ISO 3166-1</a> ).
    ...
    <ParamField body="seller_details" type="object">
      ...
      <Expandable title="properties">
        ...
        <ParamField body="industry" type="enum">
          ...
          Possible enum values: Check the <a href="industry-category-list">Industry category</a>.
        </ParamField>
        ...
        <ParamField body="country" type="enum">
          ...
          Possible enum values: Check the <a href="country-reference">Country code list</a>.
        </ParamField>
        ...
        <ParamField body="phone" type="object">
          ...
          <Expandable title="properties">
            ...
            <ParamField body="country_code" type="string">
              The country calling code of the seller's phone (MAX 3; MIN 1). Possible values: Check the <a href="country-reference">
                                  Country reference</a> .
        ...
        <ParamField body="address" type="object">
          ...
          <Expandable title="properties">
            ...
            <ParamField body="country" type="enum">
              The country considered for the seller's address (MAX 2; MIN 2, <a href="country-reference">ISO
                                  3166-1</a> ).
...
<ParamField body="transactions" type="object">
  ...
  <Expandable title="properties">
    ...
    <ParamField body="simplified_mode" type="boolean">
      When `true` , Yuno automatically retries capture or cancel operations if they fail. Default is `false` . You may also see this field in `delayed_capture_settings` or `delayed_cancel_settings` . For the full retry schedule, see <a href="https://docs.y.uno/docs/transaction-retries">Transaction Retries</a> and <a href="https://docs.y.uno/docs/cancel-and-capture-flow">Cancel and Capture Flow</a> .
    ...
    <ParamField body="payment_method" type="object">
      ...
      <Expandable title="properties">
        ...
        <ParamField body="parent_payment_method_type" type="enum">
          When using a wallet for payments through a <a href="https://docs.y.uno/docs/direct-flow">direct integration</a> , this field indicates the provider from which the card information was obtained.
                ...
                <ParamField body="customer_data" type="object">
                  ...
                  <Expandable title="properties">
                    ...
                    <ParamField body="identification_type" type="string">
                      ...
                      Possible values: Check the <a href="https://docs.y.uno/reference/country-reference">
                                                    Country Reference</a>. Example: DNI
                    </ParamField>
