...
Occasionally, an `X-Idempotency-Key` may be required. This UUID must be unique for each request. See [Idempotency](https://docs.y.uno/reference/authentication#idempotency) for details.
