...
<ParamField body="type" type="enum">
  ...
  Possible enum values: Check the <a href="/reference/reference/payment-type-list">
              Payment type list</a>.
</ParamField>
...
<ParamField body="country" type="enum">
  The customer's country (MAX 2; MIN 2; <a href="/reference/reference/country-reference">ISO 3166-1</a> ).
...
<ParamField body="verify" type="object">
  ...
  <Expandable title="properties">
    ...
    <ParamField body="currency" type="enum">
      Currency of the card verification.(MAX 3; MIN 3; <a href="country-reference">ISO 4217</a> ).
