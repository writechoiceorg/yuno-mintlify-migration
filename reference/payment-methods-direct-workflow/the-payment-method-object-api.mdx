...
<ParamField body="type" type="enum">
  ...
  Possible enum values: Check the <a href="payment-type-list">
              Payment type list</a>.
</ParamField>
...
<ParamField body="country" type="enum">
  The customer's country (MAX 2; MIN 2; <a href="country-reference">ISO 3166-1</a> ).
...
<ParamField body="status" type="enum">
  ...
  Possible enum values: Check the <a href="enrollment-workflow#payment-method-status">Payment method
              status</a>.
</ParamField>
