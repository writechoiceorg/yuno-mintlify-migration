...
<ParamField body="phone" type="object">
  ...
  <Expandable title="properties">
    ...
    <ParamField body="country_code" type="string">
      The country calling code of the customer's phone (MAX 3; MIN 1). Possible values: Check the <a href="/reference/reference/country-reference"> Country reference</a> .
