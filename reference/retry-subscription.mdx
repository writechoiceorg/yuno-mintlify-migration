...
openapi: "/openapi.json POST /v1/subscriptions/{id}/retry"
---
...
* Manually triggering a retry **stops** the [smart retry scheme](https://docs.y.uno/docs/retries) for the corresponding payment. The following payments of the subscription will follow the smart retry scheme if enabled in the creation.
