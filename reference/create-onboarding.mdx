...
openapi: "/openapi.json POST /v1/recipients/{recipient_id}/onboardings"
---
...
For `type: "TWO_STEP_ONBOARDING"` flows, use the [Continue Onboarding](https://docs.y.uno/reference/continue-onboarding) endpoint to complete the KYC process after account creation.
</Note>
