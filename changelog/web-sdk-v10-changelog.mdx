...
For the most current information, always refer to the [latest SDK documentation](/docs/full-checkout-sdk) and consider planning for future version migrations.