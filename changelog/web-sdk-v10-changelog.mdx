...
For the most current information, always refer to the [latest SDK documentation](https://docs.y.uno/docs/full-checkout-sdk) and consider planning for future version migrations.