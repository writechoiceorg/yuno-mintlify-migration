...
Please check the [stored credentials guide ](https://docs.y.uno/docs/stored-credentials#subscription-agreement)documentation for more detail.
...
Please check the [payouts](https://docs.y.uno/docs/payouts) documentation for more detail.
...
Please check the [currency conversion](https://docs.y.uno/docs/currency-conversion) documentation for more detail.
...
Please check the [payments](https://docs.y.uno/reference/the-payment-object) object for more detail.

## Cancel or refund a Payment

We've added a [new functionality](https://docs.y.uno/reference/cancel-or-refund-a-payment) to the payments API where you can cancel or refund a payment just by providing the `payment id`, contrary to the [existing service](https://docs.y.uno/reference/cancel-or-refund-payment-with-transaction) where the transaction\_id is necessary.  Please check the [payments](https://docs.y.uno/reference/cancel-or-refund-a-payment) API reference for more detail.