...
We've added a new object to the [Payment object](https://docs.y.uno/reference/the-payment-object) response called `routing_rules`. It is an array of objects that represents the routing rules information during the payment creation. It returns the conditions followed by the transaction.
