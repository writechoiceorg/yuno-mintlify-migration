...
For implementation guidance and examples, visit the [Web SDK documentation page](/docs/full-checkout-sdk) and the [GitHub repository](https://github.com/yuno-payments/yuno-sdk-web/blob/main/README.md) for more information.
</Note>
