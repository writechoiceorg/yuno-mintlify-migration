...
For more information, please refer to the [AFT](https://docs.y.uno/docs/account-funding-transactions-afts) guides section in the documentation.

## Network Transaction ID

We've added the possibility to send in the [Payments API](https://docs.y.uno/reference/create-payment) the `network_transaction_id` recommended for subscription payments with enrolled payment methods.
...
For more information, please refer to the [Stored credentials](https://docs.y.uno/docs/stored-credentials) guides section in the documentation.

### Smart routing flag

We've added a new field to the [Payment object](https://docs.y.uno/reference/the-payment-object) response called `smart_routing`. It's a field inside the routing rules object specifying whether a transaction went through the smart routing feature.
...
For more information, please refer to the [Subscriptions](https://docs.y.uno/docs/subscriptions) guides section in the documentation.