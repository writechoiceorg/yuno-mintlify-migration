...
For the most current information, always refer to the [latest Lite SDK documentation](https://docs.y.uno/docs/lite-checkout-sdk) and consider planning for future version migrations.

<Note>
**Lite SDK Focus**

The Lite Web SDK is designed for merchants who need essential payment functionality without the complexity of advanced features. If you require more customization options or advanced payment flows, consider the [Full Web SDK](https://docs.y.uno/docs/full-checkout-sdk) instead.
</Note>