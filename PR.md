...
This PR aligns the newly migrated SDK documentation with the Mintlify environment, standardizing the folder structure, converting to MDX, and fixing critical navigation issues across the site.
...
- **Navigation Overhaul**: Updated `docs.json` and all `_order.yaml` files to reflect the new kebab-case hierarchy, replacing the legacy "Yuno SDKs" anchor with a cleaner "SDKs" section.
