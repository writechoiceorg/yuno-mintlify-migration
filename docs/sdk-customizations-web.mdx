...
<Columns cols={2}>
  <Card title="Default Design" href="sdk-customizations-default-design-web" arrow/>

  <Card title="Deprecated Design" href="sdk-customizations-deprecated-design-web" arrow/>
</Columns>
