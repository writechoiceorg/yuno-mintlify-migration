...
Now that you've completed the dashboard setup and obtained your API credentials, proceed to [Create your first payment](https://docs.y.uno/docs/step-2-your-first-payment) to continue with the integration guide.