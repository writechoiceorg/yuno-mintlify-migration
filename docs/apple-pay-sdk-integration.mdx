...
Before implementing Apple Pay payments, ensure you have completed the [prerequisites](https://docs.y.uno/docs/prerequisites-apple-pay).
</Note>
...
Use the [create checkout session](https://docs.y.uno/reference/create-checkout-session) endpoint to create a payment session for one-time Apple Pay transactions:
...
Monitor payment status through [webhooks](https://docs.y.uno/docs/webhooks) to handle edge cases and provide customer notifications.
...
* [Apple Pay Direct integration](https://docs.y.uno/docs/apple-pay-direct-integration)
