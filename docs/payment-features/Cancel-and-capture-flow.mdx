...
Delayed capture only applies when capturing the **full amount** of the authorization. If you need to capture a partial amount, you must use [manual capture](https://docs.y.uno/docs/capture-payments) instead.
</Warning>
