...
* [Fee](https://docs.y.uno/docs/payment-amount-details#fee-amount)
* [Shipping](payment-amount-details#shipping-amount)
* [Tips](https://docs.y.uno/docs/payment-amount-details#tips)
* [Taxes](https://docs.y.uno/docs/payment-amount-details#taxes)
* [Discounts](https://docs.y.uno/docs/payment-amount-details#discounts)
* [Customer validations](https://docs.y.uno/docs/payment-amount-details#customer-validations)
