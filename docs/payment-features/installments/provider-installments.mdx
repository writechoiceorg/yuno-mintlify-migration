...
When using Secure Fields SDK integration, you will need to [enable the installments option](/docs/payment-secure-fields#step-3-start-the-checkout-process) while starting the checkout process.
</Warning>
