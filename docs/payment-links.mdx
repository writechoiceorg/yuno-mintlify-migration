...
1. (Optional) Create a customer using the [Create customer](https://docs.y.uno/reference/create-customer) endpoint.
2. Create the payment link using the [Create payment link](https://docs.y.uno/reference/create-payment-link) endpoint.
