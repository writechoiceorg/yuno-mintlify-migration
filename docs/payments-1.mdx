...
Payments collect essential order details, including customer information, total amount, currency, products, shipping details, and more. For a deeper understanding of order and payment interactions, refer to the [Transactions](https://docs.y.uno/docs/transactions) page.
...
In the [Payments](https://docs.y.uno/docs/payments) section of your Yuno dashboard, you can view and export all payment and transaction details.

For more details on how transactions impact payment outcomes, refer to the [Transactions](https://docs.y.uno/docs/transactions) section.