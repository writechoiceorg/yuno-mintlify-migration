...
1. Use the [Create Customer](https://docs.y.uno/reference/create-customer) endpoint and provide your own `merchant_customer_id` (the unique id of the customer in your system). The response returns `id` which is the Yuno customer id.
2. Use [Retrieve Customer](https://docs.y.uno/reference/retrieve-customer) with the Yuno `id`.
3. Use [Retrieve Customer by External Id](https://docs.y.uno/reference/retrieve-customer-by-external-id) with query parameter `merchant_customer_id`.
...
Use [Enroll Payment Method](https://docs.y.uno/reference/enroll-payment-method-api) with the following request parameters:
...
Use [Retrieve Enrolled Payment Method by id](https://docs.y.uno/reference/retrieve-enrolled-payment-method-by-id-api) with the `vaulted_token`. A successful enrollment returns:
...
Use [Create payment](https://docs.y.uno/reference/create-payment) with the Direct workflow and NuPay type. Include the selected plan id and installments in the wallet `card_data`.
...
Use [Retrieve payment by id](https://docs.y.uno/reference/retrieve-payment-by-id) to confirm final status.
...
3. Create a subscription with the enrolled `vaulted_token` using [Create subscription](https://docs.y.uno/reference/create-subscription)
4. Retrieve the subscription using [Retrieve subscription](https://docs.y.uno/reference/retrieve-subscription)
...
* [Create customer](https://docs.y.uno/reference/create-customer)
* [Retrieve customer](https://docs.y.uno/reference/retrieve-customer)
* [Retrieve customer by external id](https://docs.y.uno/reference/retrieve-customer-by-external-id)
* [Enroll payment method (Direct)](https://docs.y.uno/reference/enroll-payment-method-api)
* [Retrieve enrolled payment method by id](https://docs.y.uno/reference/retrieve-enrolled-payment-method-by-id-api)
* [Create payment](https://docs.y.uno/reference/create-payment)
* [Retrieve payment by id](https://docs.y.uno/reference/retrieve-payment-by-id)
* [Create subscription](https://docs.y.uno/reference/create-subscription)
* [Retrieve subscription](https://docs.y.uno/reference/retrieve-subscription)