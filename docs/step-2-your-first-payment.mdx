...
After accessing the running project in your browser, you'll see a basic checkout page displaying the Card payment method configured in [Set Up Your Account](https://docs.y.uno/docs/step-1-set-up-your-account). To create your first successful payment:
