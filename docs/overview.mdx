...
With Yuno's services, managing multiple payment gateways is simplified, streamlining the payment process. Instead of integrating with several payment providers individually, you only need to integrate with Yuno once to access numerous payment methods and gateways. For more information, visit the [How Yuno works](https://docs.y.uno/docs/what-is-yuno) section.

To complete this guide, follow these steps:

1. [Set up your account](https://docs.y.uno/docs/step-1-set-up-your-account)
2. [Create your first payment](https://docs.y.uno/docs/step-2-your-first-payment)
