...
For further information on standard codes for country identification, currencies, document types, and phone codes for each country, refer to the [Country reference](https://docs.y.uno/reference/country-reference) page.
