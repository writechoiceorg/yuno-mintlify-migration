...
<ParamField body="data" type="string">
  Specifies the [payment](https://docs.y.uno/reference/the-payment-object) (for payment type) or [payment method object](https://docs.y.uno/reference/the-payment-method-object-api) (for enrollment and other objects).
</ParamField>
