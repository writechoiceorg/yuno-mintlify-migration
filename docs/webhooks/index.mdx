...
For incoming transfer payload structure, see [Webhook Notifications (Banking Connectivity)](https://docs.y.uno/reference/webhook-notifications-banking). Incoming transfer notifications are sent to your endpoint at `{merchant_base_URL}/v1/banking/transfers`.
