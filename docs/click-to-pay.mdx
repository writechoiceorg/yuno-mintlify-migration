...
This feature requires the **Create customer** field to be set to **Yes** in the VTEX provider configuration. For more details, see [Configure Yuno as Provider](https://docs.y.uno/docs/configure-yuno-as-provider) in the VTEX integration documentation.
...
See the full SDK guides for detailed samples: [Android Full Checkout](https://docs.y.uno/docs/android) and [iOS Full Checkout](https://docs.y.uno/docs/ios).