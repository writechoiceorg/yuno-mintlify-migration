...
This design ensures flexibility, transparency, and full traceability throughout the onboarding lifecycle. The [recipients endpoint](https://docs.y.uno/reference/create-recipient-1) is used to create and manage each submerchant profile and to trigger the corresponding provider-specific onboarding workflows.
...
2. **Recipient Creation**: For each submerchant, the marketplace creates a recipient using the [Create Recipients API](https://docs.y.uno/reference/create-recipient-1) endpoint, specifying either:
...
In this section, we explore how the `split_marketplace` object is used to divide a [payment](https://docs.y.uno/reference/create-payment) among multiple recipients. This object is an array where each entry specifies a recipient and their corresponding share of the payment.
...
* If using multiple payment providers for split payments, we recommend utilizing the [recipients object](https://docs.y.uno/reference/create-recipients), as it allows defining more than one provider for each recipient.

## API endpoints involved

This section lists the API endpoints involved in managing split payments.

* **[Create recipients](https://docs.y.uno/reference/create-recipient-1)**: **POST**: `https://api-sandbox.y.uno/v1/recipients`
* **[Create onboarding](https://docs.y.uno/reference/create-onboarding)**: **POST**: `https://api-sandbox.y.uno/v1/recipients/{recipient_id}/onboardings`
* **[Continue onboarding](https://docs.y.uno/reference/continue-onboarding)**: **POST**: `https://api-sandbox.y.uno/v1/recipients/{recipient_id}/onboardings/{onboarding_id}/continue`
* **[Create payment](https://docs.y.uno/reference/create-payment)**: **POST**: `https://api-sandbox.y.uno/v1/payments`
* **[Capture authorization](https://docs.y.uno/reference/capture-authorization)**: **POST**: `https://api-sandbox.y.uno/v1/payments/{id}/transactions/{transaction_id}/capture`
* **[Refund payment](https://docs.y.uno/reference/refund-payment)**: **POST**: `https://api-sandbox.y.uno/v1/payments/{id}/transactions/{transaction_id}/refund`
