...
4. Provide a **Name** for the connection, select **Apple Pay** as **Payment method**, and provide the information you acquired when following the [Prerequisites](https://docs.y.uno/docs/prerequisites-apple-pay) process, click **Next**.
...
<Note>
  Visit the [Routing](https://docs.y.uno/docs/routing) page for additional information on this step.
</Note>
...
<Note>
  Visit the [Checkout Builder](https://docs.y.uno/docs/checkout-builder) page for additional information on this step.
</Note>
...
* **SDK Integration**: [one-time](https://docs.y.uno/docs/apple-pay-sdk-integration#one-time-payments-with-sdk) and [recurring](https://docs.y.uno/docs/apple-pay-sdk-integration#recurring-payments-with-sdk)
* **Direct integration**: [one-time](https://docs.y.uno/docs/apple-pay-direct-integration#one-time-payments-with-direct-api)  and [recurring](https://docs.y.uno/docs/apple-pay-direct-integration#recurring-payments-with-direct-api)
