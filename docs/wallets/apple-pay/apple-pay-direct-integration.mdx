...
<Note>
  Before implementing Apple Pay payments, ensure you have completed the [Apple Pay prerequisites](https://docs.y.uno/docs/prerequisites-apple-pay).
</Note>
...
3. [Create a payment](https://docs.y.uno/reference/create-payment) with Yuno including the stringified token
4. Yuno processes with your configured provider(s) and returns a response
5. Monitor response status via [webhooks](https://docs.y.uno/docs/webhooks)

## One-time payments

To integrate a single transaction, such as an online purchase, use Yuno's API to [create a payment](https://docs.y.uno/reference/create-payment). This requires you to obtain certain information from the Apple SDK's response, which is generated when the customer authorizes the payment.
...
When a customer authorizes the subscription and you have a response from the Apple SDK, use the stringified `payment_token` in Yuno's [create payment API](https://docs.y.uno/reference/create-payment) to create the CIT.
...
* [Prerequisites for Apple Pay](https://docs.y.uno/docs/prerequisites-apple-pay)
* [Apple Pay SDK integration](https://docs.y.uno/docs/apple-pay-sdk-integration)
* [Create payment API](https://docs.y.uno/reference/create-payment)
* [Subscription management](https://docs.y.uno/docs/subscriptions)
