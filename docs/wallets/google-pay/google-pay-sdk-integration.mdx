...
* Yuno SDK integrated in your application ([Web](/docs/web-sdk-reference), [Android](/docs/android-sdk-reference), or [iOS](/docs/ios-sdk-reference))
...
* [Web SDK integration](/docs/web-sdk-full)
* [Android SDK integration](/docs/android-sdk-full)
* [iOS SDK integration](/docs/ios-sdk-full)
...
1. Integrate [Yuno's SDK](/docs/android) into your app.
