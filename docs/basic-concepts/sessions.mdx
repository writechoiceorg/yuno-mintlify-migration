...
For more detailed information on how to use the Create customer session endpoint, see [API reference](https://docs.y.uno/reference/the-customer-session-object).
...
For more detailed information on how to use the **Create checkout session** endpoint, refer to the [API reference](https://docs.y.uno/reference/the-checkout-session-object).