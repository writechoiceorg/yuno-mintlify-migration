...
To integrate Apple Pay using Yuno, you must first complete the [Prerequisites ](https://docs.y.uno/docs/prerequisites-apple-pay) process. After, choose the integration option that best fits you and access the respective integration documentation:

* [SDK Integration](https://docs.y.uno/docs/apple-pay-sdk-integration)
* [Direct Integration](https://docs.y.uno/docs/apple-pay-direct-integration)
