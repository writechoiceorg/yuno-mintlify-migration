...
<Card title="Token migration via API" href="via-api" arrow/>
...
Refer to the [Customer Object](https://docs.y.uno/reference/the-customer-object) and [Payment Method Object](https://docs.y.uno/reference/the-payment-method-object-api) to explore all possible parameters for importing/creating customers or enrolling payment objects.
