...
Create a customer using the [Create customer endpoint](/reference). This customer is required for checkout sessions and saved cards.
...
For more iOS customization options, see [SDK customizations (iOS)](../customization/ios).
...
Configure styles in your `Application` class during SDK initialization in `MyApp.kt`. For more Android customization options including XML themes and drawable customization, see [SDK customizations (Android)](../customization/android).
