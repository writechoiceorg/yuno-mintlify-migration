...
* A [customer](/reference) created in Yuno and a [checkout session](/reference/checkout-sessions/create-checkout-session): reference each API when setting up your backend.
