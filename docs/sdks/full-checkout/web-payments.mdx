...
* A [customer](ref:create-customer) created in Yuno and a [checkout session](/reference/checkout-sessions/create-checkout-session): reference each API when setting up your backend.
...
After including the library ([step 1](#step-1-include-the-library-in-your-project)), initialize the SDK. See [Quickstart guide](../overview/quickstart#web-sdk-integration) for initialization.
