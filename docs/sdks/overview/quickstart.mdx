...
For a comprehensive overview of all Web SDK parameters, see [Web SDK Common Reference](../resources/references/web).
...
For a comprehensive overview of all iOS SDK parameters, see [iOS SDK Common Reference](../resources/references/ios).
...
For a comprehensive overview of all Android SDK parameters, see [Android SDK Common Reference](../resources/references/android).
