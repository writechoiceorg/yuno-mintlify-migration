...
Include the library in your project by following the same steps as in [full-checkout](../full-checkout/android-payments#include-the-library-in-your-project).
