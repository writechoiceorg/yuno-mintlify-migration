...
Include the library in your project by following the same steps as in [Full Checkout](../Full Checkout/ios-payments#include-the-library-in-your-project).
...
For styling, themes, form options, and additional configurations, see [SDK customizations](../Customization/ios).
