...
<Callout icon="📘" theme="info">
  Not sure which integration to use? See the [Google Pay overview](https://docs.y.uno/docs/google-pay#integration-options) to compare all three options.
</Callout>

## Requirements

Before starting, ensure you meet the [general Google Pay requirements](https://docs.y.uno/docs/google-pay#requirements). Additionally, you need to register with the [Google Pay Business Console](https://pay.google.com/business/console) to obtain a Google merchant ID. Complete the console configuration by following these steps:
...
2. Create a route in Yuno's dashboard using the processor you want for Google Pay payments. See the [Configure dynamic routing](https://docs.y.uno/docs/routing#configuring-the-dynamic-routing) guide for more information.
...
* [Google Pay SDK integration](https://docs.y.uno/docs/google-pay-sdk-integration)
