...
* `customer_payer.id`: The ID of the previously [generated customer](https://docs.y.uno/reference/create-customer)
...
After obtaining the `vaulted_token`, you can proceed with your subscription schedule. Use the [Get payment methods](https://docs.y.uno/reference/retrieve-enrolled-payment-methods-api) endpoint to access the customer's payment methods.

For more information about creating and managing payment links, refer to the [payment link API reference](https://docs.y.uno/reference/create-payment-link).