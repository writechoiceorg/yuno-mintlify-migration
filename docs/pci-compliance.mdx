...
If your integration uses the [Direct Flow](https://docs.y.uno/docs/direct-flow), your business handles card data directly and must provide an Attestation of Compliance (AOC) signed by your company and a certified auditor.
</Note>
...
For a full breakdown of token types and how they work, see [Tokens](https://docs.y.uno/docs/tokens).

<Frame><img src="/images/reference/pci-compliance/image2.png" /></Frame>

## Getting started

Yuno's SDK integrations are available for web (JavaScript) and mobile (iOS, Android, Flutter). Refer to the [SDK guide](https://docs.y.uno/docs/quickstart) to choose the right integration for your use case.
