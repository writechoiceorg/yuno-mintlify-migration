...
* Create a customer using the [Create customer endpoint](https://docs.y.uno/reference/create-customer) before enrolling
...
Create a customer in Yuno's system using the [Create customer endpoint](https://docs.y.uno/reference/create-customer) before enrolling payment methods. This endpoint returns a `customer_id`. Then create a customer session using the [Create Customer Session](https://docs.y.uno/reference/create-customer-session) endpoint; use the returned `customer_session` when calling the enrollment methods.
...
Create a customer using the [Create Customer](https://docs.y.uno/reference/create-customer) endpoint before enrolling payment methods. Then create a new `customer_session` using the [Create Customer Session](https://docs.y.uno/reference/create-customer-session) endpoint and store the `customer_session` ID for the enrollment calls.
...
| `customerSession` | Refers to the current enrollment's customer session received as a response to the [Create Customer Session](https://docs.y.uno/reference/create-customer-session) endpoint. Example: `438413b7-4921-41e4-b8f3-28a5a0141638`               |
