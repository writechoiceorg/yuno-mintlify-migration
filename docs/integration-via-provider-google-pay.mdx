...
Ensure you meet the [general Google Pay requirements](https://docs.y.uno/docs/google-pay#requirements).
...
4. Create a route in Yuno's dashboard using the gateway you have connected. Access the [Configure dynamic routing](https://docs.y.uno/docs/routing#configuring-the-dynamic-routing) guide page for further information on creating routes.
...
1. First, integrate [Yuno's SDK](https://docs.y.uno/docs/android) into your app to ensure a smooth connection between your application and Yuno's platform.
