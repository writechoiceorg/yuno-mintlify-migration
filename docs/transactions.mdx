...
Each payment has one or more associated transactions. A payment on Yuno can go through multiple processors via fallbacks, retries, or split routing, containing multiple transactions. You can check all transactions related to a payment in the [payment timeline](https://docs.y.uno/docs/payments) on your Yuno dashboard.
...
In the [Payments](https://docs.y.uno/docs/payments) section of your Yuno dashboard, you will be able to view and export all the information regarding your payments and transactions with Yuno.