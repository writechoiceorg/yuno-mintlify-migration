...
As [mentioned before](/reference/pix-automático-overview), have in mind that the information defined in the subscription creation will restrict the dates and values to be used for future payments.
