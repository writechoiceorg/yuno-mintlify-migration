...
* **[SDK integration](https://docs.y.uno/docs/google-pay-sdk-integration)**: Yuno's SDK handles the full flow, including presenting PIX as an option within Google Pay.
* **[Direct integration](https://docs.y.uno/docs/google-pay-direct-integration)**: You manage the Google Pay frontend and pass the PIX payment token to Yuno.
* **[Provider integration](https://docs.y.uno/docs/integration-via-provider-google-pay)**: Your payment provider handles the Google Pay + PIX flow.
...
See [Webhooks](https://docs.y.uno/docs/webhooks) for configuration details.
