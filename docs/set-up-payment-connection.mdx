...
> >
> > Make sure to choose the payment connection that suits your needs when following these instructions. If you want to test credit card payments, use [Yuno Testing Gateway](https://docs.y.uno/docs/yuno-testing-gateway) as your provider.
