export const FeatureCards = () => {
  const FeatureItem = ({ href, title, desc, ai = false }) => (
    <li className="flex gap-2 items-start mb-4 text-sm leading-relaxed">
      <span className={`shrink-0 mt-0.5 text-base ${ai ? "text-[#fbbf24]" : "text-[#111827] dark:text-[#d4d5da]"}`}>✓</span>
      ...
      <div className="max-w-[1200px] mx-auto">
        <div className="grid gap-8 mb-16" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))" }}>
          ...
          <Card>
            ...
            <CardCta href="/getting-started/introduction">Learn about Yuno</CardCta>
            <ul className="list-none p-0 m-0">
              <FeatureItem
                href="/core-concepts/payment-flow"
          ...
          <Card>
            ...
            <CardCta href="/guides/integration-overview">Choose your integration</CardCta>
            <ul className="list-none p-0 m-0">
              <FeatureItem
          ...
          <Card>
            ...
            <CardCta href="/api-reference">View API docs</CardCta>
            <ul className="list-none p-0 m-0">
              <FeatureItem
              ...
              />
              <FeatureItem href="/reference" title="Reference" desc=" - Essential data to get the most of our APIs." />
              <FeatureItem
                href="/guides/postman-collections"
          ...
          <Card>
            ...
            <CardCta href="/features">Explore capabilities</CardCta>
            <ul className="list-none p-0 m-0">
              <FeatureItem
                href="/features/installments"
                title="Installments"
          ...
          <Card ai>
            <div className="absolute top-4 right-4 bg-emerald-500 text-white px-2 py-1 text-xs font-semibold">NEW</div>
            <div className="flex items-center gap-3 mb-4">
              <CardIcon ai>
          ...
          <Card>
            ...
            <CardCta href="/platform">Learn more</CardCta>
            <ul className="list-none p-0 m-0">
              <FeatureItem
          ...
          <Card>
            ...
            <CardCta href="/security">View security features</CardCta>
            <ul className="list-none p-0 m-0">
              <FeatureItem
