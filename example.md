...
```json
{
  ...
  "paths": {
    "/{customer_id}/payment-methods/{payment_method_id}/unenroll": {
      "post": {
        ...
        "parameters": [
          ...
          },
          {
            ...
            "in": "path",
            "description": "The unique identifier of the payment method. This is the `vaulted_token` received when enrolling a payment method using [Enroll Payment Method](https://docs.y.uno/reference/enroll-payment-method-api) (UUID, 36 chars).",
            "schema": {
              "type": "string"
            },
            "required": true
